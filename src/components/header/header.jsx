    ...
    <div className="Header-Image ">
      ...
      <div className="mx-20 flex lg:flex-row md:flex-col max-sm:flex-col max-sm:text-center max-sm:m-auto ">
        <div className="space-y-10 m-auto lg:text-left md:text-center ">
          <h1 className="font-poppins text-[41px] w-3/4 leading-[3rem] lg:m-0 md:m-auto max-sm:text-[28px] max-sm:w-full ">
            Build The Community Your Fans Will Love
          </h1>
          <p className="font-opensans text-[18px] w-11/12 lg:m-0 md:m-auto max-sm:ml-3 ">
